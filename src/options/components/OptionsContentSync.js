    ...
    <>
      <div className="rounded-lg bg-white shadow-lg text-sm">
        <div className="px-6 py-8">
          ...
          <p>
            Extension automatically loads your categories and projects every 30
            minutes but you can also manually load them by clicking the button
      ...
      <div className="rounded-lg bg-white shadow-lg text-sm mt-8">
        <div className="px-6 py-8">
          ...
          <p>
            Extension automatically loads your labels every 30 minutes but you
            can also manually load them by clicking the button below. Use this
